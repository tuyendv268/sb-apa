...
def main(libri_chain_txt_path, acoustic_model_path):
    ...
    ftdnn = FTDNNAcoustic(num_senones=6128)
...
parser.add_argument("--libri_chain_txt_path", type=str, required=True)
parser.add_argument("--acoustic_model_path", type=str, required=True)

args = parser.parse_args()

libri_chain_txt_path = args.libri_chain_txt_path
acoustic_model_path = args.acoustic_model_path

# libri_chain_txt_path = "/workspace/kaldi/stt/exp/chain_cleaned/tdnn_1d_sp/final.txt"
# acoustic_model_path = "/workspace/train/exp/kaldi/torch/acoustic_model_1.pt"
